...
#plot!(qp,ftq_mom2,xlims=(0,50),label = "FT \$q_{mom}\$",linewidth=2,
...
savefig("exp2_pot_disc_bump_FT.png")

p4=plot(r,fr,label = L"q",linestyle = :dash,linewidth=2,
xtickfontsize=16,ytickfontsize=16,legendfontsize=16,xguidefontsize=16,yguidefontsize=16)
#plot!(rp,q_mom,xlims=(0,1),label = L"q_{mom}",linewidth=2)
plot!(rp,q_exp,label = L"q_{exp}", xlabel = "r",linewidth=2,xlims=(0,1),
     xtickfontsize=16,ytickfontsize=16,legendfontsize=16,xguidefontsize=16,yguidefontsize=16,
     bottom_margin=5mm, right_margin=10mm,ylims=(-30,25))
display(p4)
savefig("exp2_pot_disc_bump.png")
