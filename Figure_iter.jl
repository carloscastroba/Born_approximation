...
err_l2_s = FileIO.load("results_iter.jld2","err_l2")
err_lin_s = FileIO.load("results_iter.jld2","err_lin")
...
display(p1)
savefig(p1,"ejem_pot_iter_conv_l2.png")
...
p2= plot!(iter2,log10.(err_lin_d),label = L"q_{disc}",legendfontsize=16,linewidth=2,marker=(:square),markersize=5,ylims=(-3,0.5))

display(p2)
savefig(p2,"ejem_pot_iter_conv_lin.png")